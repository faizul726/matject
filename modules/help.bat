...
echo The ZIP files can be downloaded from !CYN!mcpebd.github.io/mats!RST!
...
echo You can be sure by downloading verifyBackup.bat from !CYN!mcpebd.github.io/mats!RST!
